...
import { useAuth } from "@/app/components/auth/auth-context"; // pastikan path benar
...
export default function SignUp() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-[url('/beach.jpg')] bg-cover bg-center relative">
      {/* Overlay */}
